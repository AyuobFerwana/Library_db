...
@section('title-secound', 'Edit Book')
        ...
        <div class="row g-4">
            ...
            <div class="col-md-12">
                <div class="card card-info card-outline mb-4">
                    ...
                    <!--end::Header-->
                    <!--begin::Form-->
                    <form class="needs-validation" method="post" action="{{ route('book.update', $book->id) }}" novalidate>
                        @method('put')
                        <!--begin::Body-->
                        <div class="card-body">
                            @csrf
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" value="{{ $book->page_number }}" class="form-control"
